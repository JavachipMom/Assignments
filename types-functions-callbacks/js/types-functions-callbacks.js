 ...
 */
 // I reREAD the instructions and realized you wanted the function CALLED sum but both seem to work, which I feel good about
 ...
 */
 function sum(number1, number2){
    if (Number.isInteger(number1 || number2) === false){
      return null;
    }
    else{
      return number1 + number2;
